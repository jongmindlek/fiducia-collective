...
const works = [
  { number: "01", category: "뮤직비디오", title: "여진(L∞na) ‘Red Hot Chili Summer’ Official MV", role: "조명감독", year: "2026", image: "/media/portfolio/01/cover.jpg", gallery: [], youtube: "Kdggz2tSGRU" },
  { number: "02", category: "단편영화", title: "어른아이", role: "촬영 및 조명감독", year: "2024", image: "/media/portfolio/02/cover.jpg", gallery: ["/media/portfolio/02/cover.jpg", ...Array.from({ length: 6 }, (_, i) => `/media/portfolio/02/${String(i + 1).padStart(2, "0")}.jpg`)] },
  { number: "03", category: "단편영화", title: "서울의 델라", role: "촬영 및 조명감독", year: "2026", image: "/media/portfolio/03/cover.jpg", gallery: ["/media/portfolio/03/cover.jpg", ...Array.from({ length: 8 }, (_, i) => `/media/portfolio/03/${String(i + 1).padStart(2, "0")}.jpg`)] },
  { number: "04", category: "단편영화", title: "우리는 가족이니까", role: "촬영감독", year: "2024", image: "/media/portfolio/04/cover.jpg", gallery: ["/media/portfolio/04/cover.jpg", ...Array.from({ length: 14 }, (_, i) => `/media/portfolio/04/${String(i + 1).padStart(2, "0")}.jpg`)] },
  { number: "05", category: "단편영화", title: "지나고 이어져 망가진", role: "연출감독", year: "2024", award: "전국대학독립영화제 본선 입상", image: "/media/portfolio/05/cover.jpg", gallery: ["/media/portfolio/05/cover.jpg", ...Array.from({ length: 6 }, (_, i) => `/media/portfolio/05/${String(i + 1).padStart(2, "0")}.jpg`)] },
  { number: "06", category: "단편영화", title: "벽", role: "조명감독", year: "2023", award: "전국대학독립영화제 본선 입상", image: "/media/portfolio/06/cover.jpg", gallery: ["/media/portfolio/06/cover.jpg", ...Array.from({ length: 6 }, (_, i) => `/media/portfolio/06/${String(i + 1).padStart(2, "0")}.jpg`)] },
];
  ...
  return (
    <main>
      ...
      <section className="hero" id="top" ref={heroRef}>
        ...
        <a className="hero-youtube-hit" href="https://youtu.be/AnSGSP2tx3M?si=d2H1ysXXRrGPYRvr" target="_blank" rel="noreferrer" aria-label="2025 쇼릴 유튜브에서 보기" />
        <div className="hero-controls">
          <a className="reel-link" href="https://youtu.be/AnSGSP2tx3M?si=d2H1ysXXRrGPYRvr" target="_blank" rel="noreferrer"><span className="play">▶</span><span>2025 SHOWREEL</span></a>
